(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@angular/core'), require('reflect-metadata'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/forms', '@angular/core', 'reflect-metadata', '@angular/common'], factory) :
	(factory((global.ng2 = global.ng2 || {}, global.ng2.simple = global.ng2.simple || {}, global.ng2.simple.timepicker = {}),global.ng.forms,global.ng.core,global.Reflect.metadata,global.ng.common));
}(this, (function (exports,forms,core,reflectMetadata,common) { 'use strict';
...
exports.TimePicker = (function () {
    function TimePicker(_renderer, _elementRef, _ngModel) {
        ...
        this.changeTime = new core.EventEmitter();
        this.timeFormatError = new core.EventEmitter();
        this.hideTimepicker = new core.EventEmitter();
        this.selectTime = new core.EventEmitter();
        this.showTimepicker = new core.EventEmitter();
        this.timeRangeError = new core.EventEmitter();
...
__decorate([
    core.Input('ng2-simple-timepicker'),
    __metadata("design:type", TimePickerConfig)
], exports.TimePicker.prototype, "options", void 0);
__decorate([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.TimePicker.prototype, "changeTime", void 0);
__decorate([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.TimePicker.prototype, "timeFormatError", void 0);
__decorate([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.TimePicker.prototype, "hideTimepicker", void 0);
__decorate([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.TimePicker.prototype, "selectTime", void 0);
__decorate([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.TimePicker.prototype, "showTimepicker", void 0);
__decorate([
    core.Output(),
    __metadata("design:type", core.EventEmitter)
], exports.TimePicker.prototype, "timeRangeError", void 0);
exports.TimePicker = __decorate([
    core.Directive({
    ...
    __metadata("design:paramtypes", [core.Renderer, core.ElementRef, forms.NgModel])
], exports.TimePicker);
...
exports.TimePickerModule = (function () {
    function TimePickerModule() {
    }
    return TimePickerModule;
}());
exports.TimePickerModule = __decorate$1([
    core.NgModule({
        imports: [
            common.CommonModule,
            forms.FormsModule
